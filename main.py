...
# PlayTimeGenre:
df_playtimegenre_final = pd.read_csv("df_playtimegenre_final.csv")

# UserForGenre:
df_userforgenre_final = pd.read_csv("df_userforgenre_final.csv")

# UsersRecommend:
df_usersrecommend = pd.read_csv("df_usersrecommend.csv")

# UsersWorstDeveloper:
df_usersworstdeveloper = pd.read_csv("df_usersworstdeveloper.csv")

# sentiment_analysis:
df_sentiment_analysis = pd.read_csv("df_sentiment_analysis.csv")

# recomendacion_juego:
df_recom_game = pd.read_csv("df_recom_game.csv")

# recomendacion_usuario:
user_df = pd.read_csv("user_df.csv")
videogames_df = pd.read_csv("videogames_df.csv")
